 ...
 * @author Admin
 */
public class MyPham extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        label1.setText("QUẢN LÝ MỸ PHẨM");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "MÃ MỸ PHẨM", "TÊN MỸ PHẨM", "LOẠI MỸ PHẨM", "XUẤT XỨ", "ĐƠN GIÁ"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel1.setText("MÃ MỸ PHẨM:");

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel2.setText("TÊN MỸ PHẨM:");

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel3.setText("LOẠI MỸ PHẨM:");
        ...
        try{
            try (PreparedStatement ps = ketNoi.prepareStatement(sql); ResultSet rs = ps.executeQuery()) {
                while(rs.next()){
                    ...
                    vt.add(rs.getString("TENMYPHAM").trim());
                    vt.add(loadTenLoai(rs.getString("MALOAIMYPHAM").trim()));
                    vt.add(rs.getString("XUATXU").trim());
                    vt.add(String.format("%,d", rs.getInt("DONGIA")));
                    String ma = rs.getString("MAMYPHAM").trim();
                    dtm.addRow(vt);
                }
    ...
    private void jButton_ThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ThemActionPerformed
        String maMP = jTextField_Ma.getText();
        String tenMP = jTextField_Ten.getText();
        ...
        int KTMaMP = 0, KTTenMP = 0,KTImage = 0, KTDonGia = 0, KTXuatXu = 0, KTLoai = 0;
        if(maMP.equals("")){
            KTMaMP = 1;
            JOptionPane.showMessageDialog(this, "Mã Mỹ Phẩm Không Được Trống");
        }
        else if(tenMP.equals("")){
            KTTenMP = 1;
            JOptionPane.showMessageDialog(this, "Tên Mỹ Phẩm Không Được Trống");
        }
        ...
        else if(KTMaMP != 1 && KTTenMP != 1 && KTImage != 1 && KTDonGia != 1 && KTXuatXu != 1 && KTLoai != 1){
            int check = kiemTraMyPham(maMP);
            int check2 = KTTenMP(tenMP);
            if(check == 1){
                JOptionPane.showMessageDialog(this, "Mỹ Phẩm Đã Tồn Tại");
            }
            else if(check2 == 1){
                JOptionPane.showMessageDialog(this, "Tên Mỹ Phẩm Đã Tồn Tại");
            }
            else if(check != 1 && check2 != 1){
                if(KTTenLoai(tenLoai) != 1){
                    luuLoaiMP(String.valueOf(demLoai()), tenLoai);
                    jComboBox_Loai.removeAllItems();
                    loadLoai();
                }
                luuMyPham(maMP, tenMP, picture, donGia, xuatXu, moTa, String.valueOf(layMaLoai(tenLoai)));
                luuTinhTrang(maMP, "0", "0", "0");
                JOptionPane.showMessageDialog(this, "Thêm Mỹ Phẩm Thành Công");
                Load_MyPham();
            }
        }
    }//GEN-LAST:event_jButton_ThemActionPerformed
    private void luuMyPham(String maMP, String tenMP, byte [] hinh, String donGia, String xuatXu, String moTa, String maLoai){
        Connection ketNoi = KetNoiSQL.layKetNoi();
        String sql = "INSERT INTO MYPHAM VALUES (?, ?, ?, ?, ?, ?, ?)";
        try{
            PreparedStatement ps = ketNoi.prepareStatement(sql);
            ps.setString(1, maMP);
            ps.setString(2, tenMP);
            ps.setBytes(3, hinh);
    ...
    private void luuTinhTrang(String maSP, String SLTot, String SLSD, String SLHong){
        Connection ketNoi = KetNoiSQL.layKetNoi();
        String sql = "INSERT INTO TINHTRANGMYPHAM VALUES (?, ?, ?, ?)";
        try{
            PreparedStatement ps = ketNoi.prepareStatement(sql);
            ps.setString(1, maSP);
    ...
    private void luuLoaiMP(String maLoai, String tenLoai){
        Connection ketNoi = KetNoiSQL.layKetNoi();
        String sql = "INSERT INTO LOAIMYPHAM VALUES (?, ?)";
        try{
            PreparedStatement ps = ketNoi.prepareStatement(sql);
    ...
    private void jButton_SuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_SuaActionPerformed
        ...
        String tenLoai = (String) jComboBox_Loai.getSelectedItem();
        int KTMaMP = 0, KTTenMP = 0,KTImage = 0, KTDonGia = 0, KTXuatXu = 0, KTLoai = 0;
        int kt = kiemTraMyPham(maMP);
        String sql = "UPDATE MYPHAM SET TENMYPHAM = ?, HINHANH = ?, DONGIA = ?, XUATXU = ?, MOTA = ?, MALOAIMYPHAM = ? WHERE MAMYPHAM = ?";
        if(maMP.equals("")){
            KTMaMP = 1;
            JOptionPane.showMessageDialog(this, "Mã Mỹ Phẩm Không Được Trống");
        }
        ...
        else if(KTTenMP(tenMP) == 1 && !layTenMP(maMP).equals(tenMP)){
            KTTenMP = 1;
            JOptionPane.showMessageDialog(this, "Tên Mỹ Phẩm Đã Tồn Tại");
        }
        else if(picture == null){
    ...
    private void jButton_XOAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_XOAActionPerformed
       String maMP = jTextField_Ma.getText();
        ...
        if(maMP.equals("")){
            ...
            int check1 = kiemTraMyPham(maMP);
            int check2 = kiemTraMPConHang(maMP);
            if(check1 == 1 && check2 == 0 ){
                ...
                JOptionPane.showMessageDialog(this, "Mỹ Phẩm Còn Hàng Còn Hạn Sử Dụng");
            }
            else{
                JOptionPane.showMessageDialog(this, "Mỹ phẩm không tồn tại");
            }
    ...
    private void loadLoai(){
        Connection ketNoi = KetNoiSQL.layKetNoi();
        String sql = "select * from LOAIMYPHAM";
        jComboBox_Loai.addItem("");
        try{
            PreparedStatement ps = ketNoi.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            while(rs.next()){
                jComboBox_Loai.addItem(rs.getString("TENLOAIMYPHAM").trim());
            }
            ketNoi.close();
    ...
    private int KTTenMP(String tenMP){
        Connection ketNoi = KetNoiSQL.layKetNoi();
        String sql = "select * from MYPHAM";
        int kt = 0;
        try{
            ...
            ResultSet rs = ps.executeQuery();
            while(rs.next()){
                if(rs.getString("TENMYPHAM").equals(tenMP)){
                    kt = 1;
                }
            }
            ketNoi.close();
    ...
    private int KTTenLoai(String tenLoai){
        ...
        try{
            ...
            ResultSet rs = ps.executeQuery();
            while(rs.next()){
                if(rs.getString("TENLOAIMYPHAM").equals(tenLoai)){
                    kt = 1;
                }
            }
            ketNoi.close();
    ...
    private int kiemTraMyPham(String maMP){
        int tontai = 0;
        Connection ketNoi = KetNoiSQL.layKetNoi();
    ...
    private String layMoTa(String maMP){
        Connection ketNoi = KetNoiSQL.layKetNoi();
        String moTa = "";
        String sql = "select MOTA from MYPHAM where MAMYPHAM = '" + maMP + "'";
        try{
            PreparedStatement ps = ketNoi.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            while(rs.next()){
    ...
    private int kiemTraMPConHang(String maMP){
        Connection ketNoi = KetNoiSQL.layKetNoi();
        int SL = 0;
    ...
    private void xoaMyPham(String maMP){
        Connection ketNoi = KetNoiSQL.layKetNoi();
        String sql = "delete from MYPHAM where MAMYPHAM = ?";
        try{
